...
describe('Launches API', () => {
  ...
  describe('Test GET /launches', () => {
    test('It should respond with 200 success', async () => {
      await supertest(app).get('/v1/launches').expect('Content-Type', /json/).expect(200);
    });
  });
  ...
  describe('Test POST /launches', () => {
    ...
    test('It should respond with 201 success', async () => {
      ...
      expect(requestDate.getUTCDate()).toBe(responseDate.getUTCDate());
      expect(requestDate.getUTCMonth()).toBe(responseDate.getUTCMonth());
      expect(requestDate.getUTCFullYear()).toBe(responseDate.getUTCFullYear());
